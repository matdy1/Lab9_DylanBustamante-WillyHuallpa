...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Lab9`.`equipo` (
  `idequipo` INT NOT NULL AUTO_INCREMENT,
  `nombreEquipo` VARCHAR(45) NOT NULL,
  `colorEquipo` VARCHAR(45) NOT NULL,
  `mascota` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idequipo`),
  UNIQUE INDEX `nombre_UNIQUE` (`nombreEquipo` ASC) VISIBLE,
  UNIQUE INDEX `color_UNIQUE` (`colorEquipo` ASC) VISIBLE,
  UNIQUE INDEX `mascota_UNIQUE` (`mascota` ASC) VISIBLE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Lab9`.`participante` (
  ...
  INDEX `fk_participante_equipo_idx` (`equipo` ASC) VISIBLE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Lab9`.`deporte` (
  `iddeporte` INT NOT NULL AUTO_INCREMENT,
  `nombreDeporte` VARCHAR(45) NOT NULL,
  `pesoDeporte` INT NOT NULL,
  PRIMARY KEY (`iddeporte`),
  UNIQUE INDEX `nombreActividad_UNIQUE` (`nombreDeporte` ASC) VISIBLE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Lab9`.`partido` (
  ...
  INDEX `fk_partido_equipo1_idx` (`equipoA` ASC) VISIBLE,
  INDEX `fk_partido_equipo2_idx` (`equipoB` ASC) VISIBLE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Lab9`.`historialPartidos` (
  ...
  INDEX `fk_historialPartidos_partido1_idx` (`partido_idpartido` ASC) VISIBLE,
  INDEX `fk_historialPartidos_deporte1_idx` (`deporte_iddeporte` ASC) VISIBLE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Lab9`.`participantesPartido` (
  `idparticipantesPartido` INT NOT NULL,
  `partido_idpartido` INT NOT NULL,
  `participante_idparticipante` INT NOT NULL,
  `horaFecha` DATETIME NOT NULL,
  PRIMARY KEY (`idparticipantesPartido`),
  INDEX `fk_participantesPartido_partido1_idx` (`partido_idpartido` ASC) VISIBLE,
  INDEX `fk_participantesPartido_participante1_idx` (`participante_idparticipante` ASC) VISIBLE,
